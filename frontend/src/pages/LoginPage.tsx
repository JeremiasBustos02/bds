        ...
        <GlassPanel className="w-full max-w-md rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-neutral-500">O continuá con</span>
              <div className="h-px flex-1 bg-white/[0.08]" />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-neutral-400">
            ¿No tenés cuenta?{' '}
            <Link to="/registro" className="font-semibold text-white transition-colors hover:text-neutral-300">
              Crear cuenta
            </Link>
          </p>
        </GlassPanel>
